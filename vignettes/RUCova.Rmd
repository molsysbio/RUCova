...
In this example we offer a mass cytometry data set consisting of 8 Head-and-Neck Squamous Cell Carcinoma (HNSCC) lines in irradiated (10 Gy) and control (0 Gy) conditions. The original data set consists of 108649 cells in total (Figure 2 and Figure 3 in the manuscript). To comply with Bioconductor regulations on the size limit, we randomly subsampled this data set to 1000 cells per cell line. 
